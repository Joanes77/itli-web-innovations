      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-8">
          <div className={`space-y-6 transform transition-all duration-700 delay-100 ${
            ...
            <button 
              className={`w-full p-4 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-all duration-300 transform hover:scale-105 hover:shadow-lg hover:shadow-blue-500/20 ${
                inView ? 'translate-y-0 opacity-100' : 'translate-y-10 opacity-0'
              }`}
              style={{ willChange: 'transform, opacity', backfaceVisibility: 'hidden' }}
            >
          ...
          <div className={`order-first md:order-last transform transition-all duration-700 delay-200 ${
            inView ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'
          }`} style={{ willChange: 'transform, opacity', backfaceVisibility: 'hidden' }}>
