  ...
  return (
    <section ref={ref} className="min-h-screen py-20 px-4 bg-gradient-to-br from-black via-blue-900/20 to-black">
      <div className="max-w-7xl mx-auto">
        <h2 className={`text-4xl md:text-5xl font-bold text-center mb-12 transform transition-all duration-500 ${
        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className={`space-y-6 transform transition-all duration-500 delay-100 ${
          ...
          {/* Imagen del servicio */}
          <div className={`order-first md:order-last transform transition-all duration-500 delay-200 ${
            inView ? 'translate-x-0 opacity-100' : 'translate-x-10 opacity-0'
          }`} style={{ willChange: 'transform, opacity' }}>
